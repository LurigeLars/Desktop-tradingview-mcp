...
The same TradingView Desktop integration must serve local and protected remote MCP clients without duplicating tools or widening the Chrome DevTools Protocol boundary.
...
- stateful Streamable HTTP for the protected remote path.
