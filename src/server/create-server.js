...
export const SERVER_INSTRUCTIONS = `TradingView MCP — 85 tools for reading and controlling a live TradingView Desktop chart.
...
export function createTradingViewServer() {
...
export function writeStartupNotice() {
